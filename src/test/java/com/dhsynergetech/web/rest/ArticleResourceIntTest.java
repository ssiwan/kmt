...
import com.dhsynergetech.repository.ArticleRepository;
import com.dhsynergetech.service.ArticleService;
import com.dhsynergetech.service.dto.ArticleDTO;
import com.dhsynergetech.service.mapper.ArticleMapper;
...
public class ArticleResourceIntTest {
    ...
    public void createArticle() throws Exception {
        ...
        assertThat(testArticle.getDetail()).isEqualTo(DEFAULT_DETAIL);
        assertThat(testArticle.getPreview()).isEqualTo(DEFAULT_PREVIEW);
    ...
    public void updateArticle() throws Exception {
        ...
        assertThat(testArticle.getDetail()).isEqualTo(UPDATED_DETAIL);
        assertThat(testArticle.getPreview()).isEqualTo(UPDATED_PREVIEW);
