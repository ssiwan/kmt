...
import { ChangelogDialogComponent } from '../../../../../../main/webapp/app/entities/changelog/changelog-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('Changelog Management Dialog Component', () => {
        let comp: ChangelogDialogComponent;
        ...
        beforeEach(async(() => {
            ...
            .overrideTemplate(ChangelogDialogComponent, '')
            .compileComponents();
        }));
            ...
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        ...
                        expect(mockEventManager.broadcastSpy).toHaveBeenCalledWith({ name: 'changelogListModification', content: 'OK'});
