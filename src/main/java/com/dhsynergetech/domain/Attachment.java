...
public class Attachment implements Serializable {
    ...
    public Attachment articles(Set<Article> articles) {
        this.articles = articles;
        return this;
    }

    public Attachment addArticle(Article article) {
        this.articles.add(article);
        article.getAttachments().add(this);
        return this;
    }

    public Attachment removeArticle(Article article) {
        this.articles.remove(article);
        article.getAttachments().remove(this);
        return this;
    }
