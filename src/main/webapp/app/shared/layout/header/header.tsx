...
export class Header extends React.Component<IHeaderProps, { menuOpen: boolean }> {
  ...
  render() {
    ...
    const entityMenuItems = [
      (
        <DropdownItem tag={Link} key="station" to="/station">
          <FaAsterisk />&nbsp;
          Station
        </DropdownItem>
      ),
      (
        <DropdownItem tag={Link} key="engine" to="/engine">
          <FaAsterisk />&nbsp;
          Engine
        </DropdownItem>
      ),
      (
        <DropdownItem tag={Link} key="attachment" to="/attachment">
          <FaAsterisk />&nbsp;
          Attachment
        </DropdownItem>
      ),
      (
        <DropdownItem tag={Link} key="article" to="/article">
          <FaAsterisk />&nbsp;
          Article
        </DropdownItem>
      ),
      (
        <DropdownItem tag={Link} key="tag" to="/tag">
          <FaAsterisk />&nbsp;
          Tag
        </DropdownItem>
      ),
      (
        <DropdownItem tag={Link} key="changelog" to="/changelog">
          <FaAsterisk />&nbsp;
          Changelog
        </DropdownItem>
      ),
      ...
      <div id="app-header">
        ...
        <Navbar dark expand="sm" fixed="top" className="jh-navbar">
          ...
          <NavbarBrand tag={Link} to="/" className="brand-logo">
            <BrandIcon />
            <span className="brand-title"><Translate contentKey="global.title">DHSKnowledgeManagement</Translate></span>
